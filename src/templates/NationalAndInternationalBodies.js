...
function NationalAndInternationalBodies() {
  return (
    ...
    <div className="container">
      <div className="main-heading text-center mb-5 text-black">
        ...
        <p>
          It's important to know how your institution is viewed and
          evaluated because this not only confirms its reputation but also
...
export default NationalAndInternationalBodies;
